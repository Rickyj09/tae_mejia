...
class paciente(db.Model):
    ...
    tipo_iden = Column(String(100), nullable=False)
    f_nac = Column(DateTime, nullable=False)
    tel1 = Column(String(100), nullable=False)
    tel2 = Column(String(100), nullable=False)
    medico = Column(String(100), nullable=False)
    id_examen = Column(Integer, nullable=False)
    est_civil = Column(String(100), nullable=False)
